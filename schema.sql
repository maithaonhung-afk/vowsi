...
ALTER TABLE users ADD COLUMN IF NOT EXISTS relationship_status TEXT DEFAULT '';
ALTER TABLE users ADD COLUMN IF NOT EXISTS children_status TEXT DEFAULT '';
ALTER TABLE users ADD COLUMN IF NOT EXISTS wants_children TEXT DEFAULT '';
ALTER TABLE users ADD COLUMN IF NOT EXISTS height_cm INTEGER;
ALTER TABLE users ADD COLUMN IF NOT EXISTS education TEXT DEFAULT '';
